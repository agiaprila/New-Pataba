...
# edit tabel
@app.route('/publikasi/pu/add', methods=['GET', 'POST'])
@login_required
def pu_add():
  if current_user.role == 'admin' or current_user.officer_of_agency == 7:
    form = FormPU()
